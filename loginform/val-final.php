...
<html lang="en">
  <head>
	...
	function onDeviceReady()
	{
		...
		var db = window.sqlitePlugin.openDatabase("phonegap", "1.0", "Demo", -1);
	...
	/* function createDB(tx)
	{
		 ...
		 tx.executeSql('CREATE TABLE IF NOT EXISTS data(nID INTEGER PRIMARY KEY AUTOINCREMENT,sName TEXT)');
	} */
	...
	function insertDB(tx){
		...
		tx.executeSql(sql, [_uname,_email,_age,_address], successCB, errorCB);
